...
pub fn resource_on(tx: i32, ty: i32, tile: TileKind) -> Option<ResourceKind> {
    ...
    match tile {
        ...
        TileKind::Tundra if h.rem_euclid(23) == 0 => Some(ResourceKind::Rock),
        TileKind::Tundra if h.rem_euclid(41) == 0 => Some(ResourceKind::Flower),
        ...
        TileKind::Jungle if h.rem_euclid(5) == 0 => Some(ResourceKind::Tree),
