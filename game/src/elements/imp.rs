...
pub(crate) fn build(
    ...
    vec![
        Part::vquad(cx - 3.0, cy - 8.0, 3.0, 8.0, shade(skin, 0.7), alpha, true),
        Part::vquad(cx + 3.0, cy - 8.0, 3.0, 8.0, shade(skin, 0.7), alpha, true),
        Part::diamond(cx + hx, cy - 14.0 + hy, 6.0, 8.0, 0.0, skin, alpha, true),
        Part::diamond(cx - 4.0 + hx, cy - 18.0 + hy, 2.0, 3.0, 0.0, horn, alpha, true),
        Part::diamond(cx + 4.0 + hx, cy - 18.0 + hy, 2.0, 3.0, 0.0, horn, alpha, true),
    ]
}
