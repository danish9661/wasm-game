...
impl StructureKind {
    ...
    pub fn color(self) -> [f32; 3] {
        match self {
            ...
            StructureKind::House => [0.82, 0.78, 0.68],
            StructureKind::Cabin => [0.58, 0.38, 0.22],
            StructureKind::Hut => [0.72, 0.58, 0.34],
            ...
            StructureKind::Inn => [0.84, 0.68, 0.50],
    ...
    pub fn sprite(self, tx: i32, ty: i32) -> Sprite {
        let (hw, hh, lift) = match self {
            ...
            StructureKind::House => (40.0, 150.0, 0.0),
            StructureKind::Cabin => (34.0, 115.0, 0.0),
            StructureKind::Hut => (28.0, 90.0, 0.0),
            StructureKind::Inn => (46.0, 125.0, 0.0),
            StructureKind::Barn => (46.0, 100.0, 0.0),
            StructureKind::Watchtower => (22.0, 180.0, 0.0),
